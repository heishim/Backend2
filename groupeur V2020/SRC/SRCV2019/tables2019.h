...
#define TAB_GESTCOMP    "gestcomp.tab"  /* Fichier d'index pour les gestes complémentaires */
...
#define CCAMDESC_NAME   "ccamdesc.tab"  /* tables d'existence des codes actes CCAM sur 10 caractères*/
#define GHSMINOR_NAME   "ghsminor.tab"  /* tables des GHS minorés*/
